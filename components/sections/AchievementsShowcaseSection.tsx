...
export const AchievementsShowcaseSection: React.FC = () => {
  return (
    <section className="relative w-full py-24 sm:py-36 bg-[#080808] border-t border-white/10 overflow-hidden select-none min-h-[85vh] flex items-center justify-center">
      ...
      {/* Visible Workspace Background Artwork (Oak Leaves, Laptop Desk & Books/Lamp) */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <Image
          src="/images/workspace_dark_bg.png"
          alt="Workspace Desk & Leaves Framing"
          fill
          priority
          className="object-cover object-center filter contrast-110 brightness-110 opacity-100"
          sizes="100vw"
        />
      </div>
      ...
      {/* Light Edge Vignette (Preserves Background Visibility) */}
      ...
      <div className="max-w-5xl mx-auto w-full px-6 relative z-10 text-center space-y-12 sm:space-y-16">
        ...
        {/* 3 Floating High-Impact Numbers & Stats (Vivid Center Alignment) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 items-start text-center">
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-white/80 font-sans max-w-xs mx-auto leading-relaxed drop-shadow-md">
