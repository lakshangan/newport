...
export const AchievementsShowcaseSection: React.FC = () => {
  return (
    <section className="relative w-full h-screen min-h-screen flex items-center justify-center bg-[#080808] border-t border-white/10 overflow-hidden select-none">
      ...
      {/* Floating Content Layout (Positioned over number.png Open Right Region) */}
      <div className="max-w-7xl mx-auto w-full px-6 sm:px-12 relative z-10 flex justify-center lg:justify-end my-auto">
        <div className="w-full lg:w-8/12 xl:w-7/12 lg:ml-auto text-center lg:text-right space-y-12 sm:space-y-16">
          ...
          {/* 3 High-Contrast Stat Columns (Aligned for number.png open dark right space) */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 items-start text-center lg:text-right">
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-white/80 font-sans max-w-xs mx-auto lg:ml-auto lg:mr-0 leading-relaxed drop-shadow-md">
            ...
            >
              ...
              <p className="text-6xl sm:text-7xl lg:text-8xl font-display font-black tracking-tight text-[#C75B32] drop-shadow-[0_0_30px_rgba(199,91,50,0.4)]">
            ...
            >
              ...
              <div className="flex items-center justify-center lg:justify-end space-x-2">
                <span className="text-5xl sm:text-6xl lg:text-7xl font-display font-black text-[#FACC15] tracking-tight drop-shadow-[0_0_30px_rgba(250,204,21,0.4)]">
                  BRONZE
                </span>
              </div>
